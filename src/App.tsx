...
import ethereumLogoLight from './assets/images/lightchainai_32.webp';
  ...
  const handleProceed = async (e: any) => {
    ...
    await knock.objects.setChannelData(
      ...
      import.meta.env.VITE_KNOCK_DISCORD_CHANNEL_ID,
      {
        connections: [
          {
            channel_id: "1399401890638336142",
          },
        ],
      }
    );
    await knock.workflows.trigger("lightchain", {
      data: {
              ...
              <div>
                <h1 className="font-medium flex items-center">
                  <div className='text-gray-800'>
                    <span className='text-xl font-semibold'>Token </span> LightchainAI <span className='text-[#6C757D]'>(LCAI)</span>
                  </div>
            ...
            <div className="bg-white rounded-lg border p-6 px-4 shadow-md">
              ...
              <div className="space-y-4">
                <div className='space-y-1.5'>
                  ...
                  <p className="text-sm">10,000,000,000 LCAI</p>
                </div>

                <div className='space-y-1.5'>
                  <p className="text-xs text-gray-500 uppercase tracking-wide">HOLDERS</p>
                  <p className="text-sm">35,890</p>
                </div>
              </div>
            </div>
